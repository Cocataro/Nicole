...
- Max — Paper trade execution. Final trade decisions, position management, P&L ledger.
- Dylon — Check AGENTS.md for current role.
- Hana — Check AGENTS.md for current role.
